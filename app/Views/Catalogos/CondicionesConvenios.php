        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="col-md-3 pl-0">
                <button class="btn btn-success mb-3" data-toggle="modal" data-target="#myModal">
                    <i class="fa fa-plus mr-1"  aria-hidden="true"></i>AGREGAR
                </button>
            </div>
            <div class="table-responsive">
                <table id="tb_condicionesconvenios" class="table table-hover table-striped" style="width: 100%;">
                    <thead>
                        <tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-header bg-success pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase text-white tx-bold">AGREGAR CONDICIONES DE DE CONVENIO</h6>
                            ...
                            <div class="row mg-b-25">                                
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class='form-control convenios' name='convenio' required></select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-header bg-warning pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase text-white tx-bold">ACTUALIZAR CONDICIONES DE CONVENIO</h6>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                        ...
                        <div class="form-layout">
                            <div class="row mg-b-25">      
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">NOMBRE DEL CONVENIO: <span class="tx-danger">*</span></label>
                                        <select id="tipo_convenio" class='form-control convenios' name='upd_convenio' required></select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">VALOR: <span class="tx-danger">*</span></label>
                                        <input id="valor" class="form-control" type="text" autocomplete="off" name="upd_valor" required>
                                    </div>
                                </div>                                
                            </div>
                        </div>
