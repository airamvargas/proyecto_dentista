...
<div class="sl-mainpanel">
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="col-12">
                <table id="crm_categoria_estudios" class="table display table-responsive product_list nowrap dataTable no-footer" style="width: 100%;">
                    <thead>
                        <tr>
                            <th class="wd-15p text-center"></th>
                            <th class="wd-15p text-center">NOMBRE</th>
                            <th class="wd-35 text-center">DESCRIPCIÓN</th>
                            ...
                            <div class="row mg-b-25">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]+" minlength="5" maxlength="50" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                        ...
                        <div class="form-layout">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">NOMBRE: <span class="tx-danger">*</span></label>
                                        <input class="form-control" type="text" id="nameCategory" name="name" pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]+" minlength="5" maxlength="50" required >
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">DESCRIPCIÓN: <span class="tx-danger">*</span></label>
                                        <textarea rows="2" class="form-control" id="description" name="description" pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]+" minlength="5" maxlength="250" required></textarea>
                                    </div>
                                </div>                      
                            </div>
                        </div>
