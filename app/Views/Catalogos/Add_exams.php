    ...
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="col-md-3 col-lg-12 pl-0">
                ...
                aria-hidden="true"></i>ASIGNAR ANALITO</button>
            ...
            <div class="mg-t-20">
                <table id="crm_exams_x_study" class="table display table-responsive product_list nowrap" style="width: 100%;">
                    <thead>
                        <tr>
                            <th class="wd-15p text-center">ESTUDIO</th>
                            <th class="wd-15p text-center">ANALITO</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            ...
            <form id="form_add" enctype="multipart/form-data">
                <div class="pd-20">
                    <div class="card pd-20 pd-sm-40">
                        <h6 class="card-body-title">Examen que pertece al estudio</h6>
                        <p class="mg-b-20 mg-sm-b-30">Rellena todos los campos</p>
                        <div class="form-layout">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">NOMBRE DEL EXAMEN: 
                                        ...
                                        <input type="hidden" name="id_exam" id="id_exam" class="form-control">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content bd-0 tx-14">
            <div class="modal-header bg-danger pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase text-white tx-bold">ELIMINAR EXAMEN</h6>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Cerrar">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" id="form_delete_exam">
