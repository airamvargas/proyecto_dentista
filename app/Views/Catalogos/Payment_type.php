...
<div class="sl-mainpanel">
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="">
                <table id="datatable" class="table table-hover table-striped table display table-responsive nowrap" style="width: 100%;">
                    <thead>
                        <tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            ...
            <form id="formCreate" enctype="multipart/form-data">
                <div class="pd-20">
                    <div class="card pd-20 pd-sm-40">
                        <h6 class="card-body-title">Datos de <?= $title ?></h6>
                            ...
                            <div class="row mg-b-25">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control forma-pago" name="id_payment_form" required>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]+" minlength="5" maxlength="30" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">DESCRIPCIÓN: <span class="tx-danger">*</span></label>
                                        <textarea rows="2" class="form-control" name="description" pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]+" minlength="5" maxlength="200" autocomplete="off" required></textarea>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn btn-danger pd-x-20 btn-cancelar">Cancelar</button>
                </div>
            </form>
        </div>
    </div><!-- modal-dialog -->
                        ...
                        <div class="form-layout">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group ">
                                        <label class="form-control-label">FORMA DE PAGO: <span class="tx-danger">*</span></label>
                                        <select id="id_payment_form" class="form-control forma-pago" name="id_payment_form" required>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">DESCRIPCIÓN: <span class="tx-danger">*</span></label>
                                        <textarea rows="2" class="form-control" id="description" name="description" pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]+" minlength="5" maxlength="250" autocomplete="off" required></textarea>
                                        <!-- <input class="form-control" type="text" name="description" required> -->
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content bd-0 tx-14">
            ...
            <form method="POST" id="formDelete">
                <div class=" pd-20">
                    <p class="mg-b-5">¿Desea eliminar este tipo de pago ? </p>
