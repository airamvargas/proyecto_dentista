                ...
                <table id="tb_convenios" class="table table-hover table-striped" style="width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th class="wd-15p text-center">Empresa</th>
                            ...
                            <div class="row mg-b-25">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control business text-uppercase" name="empresa" autocomplete="off" required></select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">NOMBRE DEL CONVENIO: <span class="tx-danger">*</span></label>
                                        <input class="form-control text-uppercase" type="text" name="nombre" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ0-9\s]+" minlength="3" maxlength="50" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                        ...
                        <div class="form-layout">
                            <div class="row mg-b-25">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">EMPRESA: <span class="tx-danger">*</span></label>
                                        <select class="form-control business text-uppercase" id="empr" name="upd_empresa" required></select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">NOMBRE DEL CONVENIO: <span class="tx-danger">*</span></label>
                                        <input class="form-control text-uppercase" id="nomb" type="text" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ0-9\s]+" minlength="3" maxlength="50" autocomplete="off" name="upd_nombre" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
...
<!-- MODAL PARA CREAR LAS CONDICIONES DE CONVENIO -->
<div id="modal_condiconvenio" class="modal fade">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-header bg-success pd-x-20">
                            ...
                            <div class="row mg-b-25">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="nom_convenio" type="text" disabled>
