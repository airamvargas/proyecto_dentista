    ...
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="col-md-3 col-lg-12 pl-0">
                ...
                aria-hidden="true"></i>ASIGNAR PREGUNTA</button>
            ...
            <div class="mg-t-20">
                <table id="datatb" class="table display table-responsive product_list nowrap" style="width: 100%;">
                    <thead>
                        <tr>
                            <th class="wd-15p text-center">ESTUDIO</th>
                            <th class="wd-15p text-center">PREGUNTA</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            ...
            <form id="form_add" enctype="multipart/form-data">
                <div class="pd-20">
                    <div class="card pd-20 pd-sm-40">
                        <h6 class="card-body-title">Pregunta que pertece al estudio</h6>
                        <p class="mg-b-20 mg-sm-b-30">Rellena todos los campos</p>
                        <div class="form-layout">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">PREGUNTA: 
                                            <span class="tx-danger">*</span>
                                        </label>
                                        <input  minlength="5" maxlength="250" type="text" id="autoComplete" class="form-control universidad" autocomplete="off" required style="background-color: white !important; color: rgba(0,0,0,.8) !important; border: black solid 1px !important;">
                                        <input type="hidden" name="id_question" id="id_question" class="form-control">
                                        <input type="hidden" name="id_study" value=<?=$id_study ?> class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content bd-0 tx-14">
            <div class="modal-header bg-danger pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase text-white tx-bold">ELIMINAR PREGUNTA DEL ESTUDIO</h6>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Cerrar">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" id="form_delete_question">
...
<script>
    let id_study = <?php echo json_encode($id_study); ?>;
</script>