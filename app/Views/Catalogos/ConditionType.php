        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="col-md-3 pl-0">
                <a href="" class="btn btn-success" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus mr-1"
                        aria-hidden="true"></i>NUEVO TIPO DE CONDICIÓN</a><br><br>
            </div>
            <div class="">
...
<!-- CREAR TIPO DE CONDICION -->
<div id="myModal" class="modal fade">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-header bg-success pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase text-white tx-bold">AGREGAR NUEVO TIPO DE CONDICIÓN</h6>
            ...
            <form id="formCreate" enctype="multipart/form-data">
                <div class="pd-20">
                    <div class="card pd-20 pd-sm-40">
                        <h6 class="card-body-title">Datos del tipo de condición</h6>
                            ...
                            <div class="row mg-b-25">                           
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea pattern="^[a-zA-Z0-9 ]*$"  maxlength="250" autocomplete="off" rows="2" class="form-control"  name="description" required></textarea>                                       
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-header bg-warning pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase text-white tx-bold">DETALLES DEL TIPO DE CONDICIÓN</h6>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                        ...
                        <div class="form-layout">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">TIPO DE CONDICIÓN: <span class="tx-danger">*</span></label>
                                        <input pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]+" minlength="5" maxlength="50" autocomplete="off" class="form-control" type="text" id="nameConditionType" name="nombre" required >
                                        <input class="form-control" type="hidden" id="idConditionType" name="id" required >
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">DESCRIPCIÓN: <span class="tx-danger">*</span></label>
                                        <textarea pattern="^[a-zA-Z0-9 ]*$" maxlength="280" autocomplete="off" rows="2" class="form-control" id="description" name="description" required></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content bd-0 tx-14">
            <div class="modal-header bg-danger pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase text-white tx-bold">Eliminar este Tipo de Condición</h6>
            ...
            <form method="POST" id="formDelete">
                <div class=" pd-20">
                    <p class="mg-b-5">¿Desea eliminar este tipo de condición? </p>
