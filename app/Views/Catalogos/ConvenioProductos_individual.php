...
Fecha de creacion:
Fecha de Ultima Actualizacion: 16 de febrero de 2024
Desarrollador que actualizo: Airam V. Vargas López
Perfil: Back Office
Descripcion: Vista de lista de producos en cada convenio de manera individual -->
...
<script>
    ...
    var dataTable = $('#crm_producto_x_convenio').DataTable({
        ...
        ajax: {
            url: `${BASE_URL}Api/Catalogos/Convenios/readProductsConvenio`,
