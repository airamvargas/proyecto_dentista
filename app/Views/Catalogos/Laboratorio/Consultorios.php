                ...
                <table id="datatable" class="table display responsive nowrap">
                    <thead>
                        <tr>
                            ...
                            <th class="wd-15p text-center">nombre del consultorio</th>
                            <th class="wd-15p text-center">descripción</th>
                            <th class="wd-15p text-center">horario inicial</th>
                            <th class="wd-15p text-center">horario final</th>
                            ...
                            <div class="row mg-b-25">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control unidad" name="id_business_unit" id="categoria" required>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]+" minlength="5" maxlength="60" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label">HORARIO INICIAL: <span class="tx-danger">*</span></label>
                    ...
                    <div class="card pd-20 pd-sm-40">
                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">NOMBRE: <span class="tx-danger">*</span></label>
                                    <input id="name" class="form-control" type="text" name="name" pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]+" minlength="5" maxlength="60" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">DESCRIPCIÓN: <span class="tx-danger">*</span></label>
                                    <textarea id="description" rows="2" class="form-control" name="description" pattern="[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]+" minlength="5" maxlength="250" required></textarea>
                                    <!-- <input class="form-control" type="text" name="description" required> -->
                                </div>
                            </div>
