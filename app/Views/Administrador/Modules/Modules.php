    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            ...
            <form id="formCreate" enctype="multipart/form-data">
                <div class="pd-20">
                    <div class="card pd-20 pd-sm-40">
                        <h6 class="card-body-title">Datos de los <?= $title ?></h6>
                        ...
                        <div class="form-layout">
                            <div class="row mg-b-25">
                                <div class="col-lg-6">
                                    ...
                                    <select name="id_group_module" class="form-control id_group_module" data-placeholder="Choose one" required>
                                    </select>
                                </div><!-- col-4 -->
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="controller" minlength="5" maxlength="60" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-control-label">ACTIVADO: <span class="tx-danger">*</span></label>
                                    <select name="active" class="form-control select2" data-placeholder="Choose one" required>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select name="phase" class="form-control select2" data-placeholder="Choose one" required>
                                        <option label="Selecciona una opción"></option>
                                        <option value="1">Activado</option>
                                        <option value="0">Desactivado</option>
                                    </select>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select name="show_in_menu" class="form-control select2" data-placeholder="Choose one" required>
                                        <option label="Selecciona una opción"></option>
                    ...
                    <div class="card pd-20 pd-sm-40">
                        ...
                        <div class="form-layout">
                            <div class="row">
                                <div class="col-lg-6">
                                    <label class="form-control-label">GRUPO: <span class="tx-danger">*</span></label>
                                    <select id="id_group_module" name="id_group_module" class="form-control id_group_module" data-placeholder="Choose one" required>
                                    </select>
                                </div><!-- col-4 -->
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label">CONTROLADOR: <span class="tx-danger">*</span></label>
                                        <input id="controller" class="form-control" type="text" name="controller" minlength="5" maxlength="60" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-control-label">ACTIVADO: <span class="tx-danger">*</span></label>
                                    <select id="active" name="active" class="form-control select2" data-placeholder="Choose one" required>
                                        <option label="Selecciona una opción"></option>
                                        <option value="1">Activado</option>
                                        <option value="0">Desactivado</option>
                                    </select>
                                ...
                                <div class="col-lg-6">
                                    <label class="form-control-label">PHASE: <span class="tx-danger">*</span></label>
                                    <select id="phase" name="phase" class="form-control select2" data-placeholder="Choose one" required>
                                        <option label="Selecciona una opción"></option>
                                        <option value="1">Activado</option>
                                        <option value="0">Desactivado</option>
                                    </select>
                                ...
                                <div class="col-lg-6">
                                    <label class="form-control-label">ACTIVO EN MENÚ: <span class="tx-danger">*</span></label>
                                    <select id="show_in_menu" name="show_in_menu" class="form-control select2" data-placeholder="Choose one" required>
                                        <option label="Selecciona una opción"></option>
                                        <option value="1">SÍ</option>
                                        <option value="0">No</option>
                                    </select>
