...
class Groups_modules extends BaseController
{
    ...
    public function index()
    {
        ...
        $session = session();
        //api path
        $controller = "Api/Administrador/Groups_modules";
        //variables
        $data_header['title'] = "Grupos de Modulos";
        $data_header['description'] = "Modulos menú Webcorp";
        $data_left['menu'] = get_menu();
        $data_fotter['controlador'] = $controller;
        $data_header['wiki_controller'] = "books/administrador/page/categorias";

        //Documents javascript 
        $data_fotter['scripts'] = [
            "../lib/datatables/jquery.dataTables.js", "../lib/datatables-responsive/dataTables.responsive.js",
            "dashboard.js", "Generales/CRUD.js", "Administrador/Groups_modules.js"
        ];
        //External js
        ...
        echo view('Administrador/Groups_modules');
