...
class ChronicDesseases extends ResourceController 
{
    use ResponseTrait;
    var $db;
    ...
    public function __construct()
    {
     ...
     public function read() {
        ...
        $model = model('App\Models\Catalogos\ChronicDesseases');
        $data["data"] = $model -> getChronicDesseases(); 
    ...
    public function readChronicDesseases(){

        $model = model('App\Models\Catalogos\ChronicDesseases');
        $request = \Config\Services::request();
        $id_bloodType = $request->getPost('id');
        $data = $model -> getChronicDesseas($id_bloodType);
        return $this->respond($data);
