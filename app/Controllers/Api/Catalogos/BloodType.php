...
class BloodType extends ResourceController 
{
    use ResponseTrait;
    var $db;
    ...
    public function __construct()
    {
     ...
     public function read() {
        ...
        $model = model('App\Models\Catalogos\Bloodtype');
        $data["data"] = $model ->getBloodTypes(); 
    ...
    public function readBloodtype(){

        $model = model('App\Models\Catalogos\Bloodtype');
        $request = \Config\Services::request();
        $id_bloodType = $request->getPost('id');
        $data = $model -> getBloodType($id_bloodType);
        return $this->respond($data);
