...
class Categorias extends BaseController
{
    ...
    public function index()
    {
        ...
        //variables
        $controller = "Api/Catalogos/Categorias";
        $data_header['title'] = "Categorias del producto";
        $data_header['description'] = "Catálogo de categorias del producto";
        $data_left['menu'] = get_menu();
        $data_fotter['controlador'] = $controller;
        $data_header['wiki_controller'] = "books/administrador/page/categorias-de-productos";

        //Documents javascript 
        $data_fotter['scripts'] = [
            "../lib/datatables/jquery.dataTables.js", "../lib/datatables-responsive/dataTables.responsive.js",
            "dashboard.js", "Generales/CRUD.js",  "Catalogos/Categorias.js"
        ];
        ...
        echo view('Catalogos/Categorias');
