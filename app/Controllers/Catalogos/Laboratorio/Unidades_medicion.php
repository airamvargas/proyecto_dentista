...
class Unidades_medicion extends BaseController
{
    ...
    public function index()
    {
        ...
        //variables
        $controller = "Api\Catalogos\Laboratorio\Unidades_medicion";
        $data_header['title'] = "Unidades de medición";
        $data_header['description'] = "Catalogo de unidades de medición";
        $data_left['menu'] = get_menu();
        $data_fotter['controlador'] = $controller;
        $data_header['wiki_controller'] = "books/administrador/page/unidad-de-medicion";

        //Documents javascript 
        $data_fotter['scripts'] = [
            "../lib/datatables/jquery.dataTables.js", "../lib/datatables-responsive/dataTables.responsive.js",
            "dashboard.js", "Generales/CRUD.js",  "Catalogos/Laboratorio/Unidades_medicion.js"
        ];
        //External js
        ...
        echo view('Catalogos/Laboratorio/Unidades_medicion');
