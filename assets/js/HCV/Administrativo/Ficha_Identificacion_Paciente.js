...
function nacionalidad() {
    $("#nacionalidad").change(function() {
        ...
        if (nacionalidad != "Mexico") {
            ...
            const ruta = BASE_URL + "/Api/HCV/Administrativo/Ficha_paciente/get_estados";
            console.log(ruta);
            $.ajax({
                type: "GET",
                url: ruta,
...
//Busqueda de la direccion ingresada en el mapa con el boton de buscar  
$(document).on('click', '#submit_form_busqueda', function(e) {
    ...
    if ($("#autocomplete").val().length < 1) {
        ...
        $('#loader').toggle();
        var url_str = `${BASE_URL}/Api/HCV/Administrativo/Ficha_paciente/data_mapa`;
...
function data_academic() {
    var url_str = `${BASE_URL}Api/HCV/Hcv_Rest_Academic`;
    $.ajax({
        url: url_str,
        type: "GET",
        dataType: 'json',
...
function religion() {
    $("#religion").keyup(function() {
        ...
        var url_str = `${BASE_URL}/Api/HCV/Administrativo/Ficha_paciente/get_religiones`;
        var language = {
            "search": search,
            "limit": "10",
            "offset": "0"
...
$("#lenguas").keyup(function() {
    ...
    var searchresult = document.getElementById("searchResult");
    var url_str = BASE_URL + "/Api/HCV/Hcv_Rest_Indigenous_l";
    var language = {
        "search": search,
        "limit": "10",
        "offset": "0"
...
$(document).on('submit', '#formCreate', function () {
    ...
    const URL = `${BASE_URL}Api/HCV/Administrativo/Ficha_paciente/create`;
