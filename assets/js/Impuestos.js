...
var data_statements = $("#estados-table").DataTable({
  ajax: {
    url: `${BASE_URL}Contabilidad/Impuestos/get_statements`,
    data: {},
    type: "post",
  },
  ...
  columns: [
    ...
    },
    {
      ...
      render: function (data, type, row, meta) {
        ...
        <a id="down_carta" href="${BASE_URL}/../../../public/Impuestos/${data}" class="down-doc" download>Ver archivo </a> `
      },
    },
    {
      data: "id",
...
$(document).on("click", ".btn-update", function (event) {
    ...
    $.ajax({
      url: `${BASE_URL}Contabilidad/Impuestos/get_statements_update`,
      type: "POST",
      data: json,
      dataType: "JSON",
      success: function (success) {
        switch (success[0].mounth) {
            case "Enero":
                mes = "01";
            break;
            case "Febrero":
        ...
        $("#empresa_update").val(success[0].id_bussines);
