...
var data_statements = $("#estados-table").DataTable({
    ajax: {
      url: `${BASE_URL}Contabilidad/Estados_cuenta/get_statements`,
      data: {},
      type: "post",
    },
    ...
    columns: [
      ...
      },
      {
        ...
        render: function (data, type, row, meta) {
          ...
          <a id="down_carta" href="${BASE_URL}/../../../public/Estados_cuenta/${data}" class="down-doc" download>Ver archivo </a> `
        },
      },
      {
        data: "id",
...
$(document).on("click", ".btn-update", function (event) {
  ...
  $.ajax({
    url: `${BASE_URL}Contabilidad/Estados_cuenta/get_update`,
    type: "POST",
    data: json,
    dataType: "JSON",
    success: function (success) {
      ...
      $("#empresa_update").val(success[0].id_business);
      $("#banco_update").val(success[0].bank);
      $("#moneda_update").val(success[0].moneda);
...
function get_moneda() {
    const empresas = BASE_URL + "/Contabilidad/Estados_cuenta/get_moneda";
    var select = $(".moneda");
    $.ajax({
      url: empresas,
      method: "GET",
