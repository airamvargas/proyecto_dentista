...
Perfil: Recolector de muestras
Descripcion: JS MUESTRAS RECOLECTADAS */
...
$(document).ready(function() {
    ...
    var url_csv = BASE_URL + '/Api/Recoleccion/Recolectadas';
    $.ajax({
        url: url_csv,
        type: "POST",
        data: {
        ...
        success: function(result) {
            ...
            table = new Tabulator("#tab_recolectadas", {
                ...
                columns:[
                    ...
                    {title:"Código", field:"Codigo", width:250, hozAlign:"center", sorter:"number"},
            ...
            success: function(result) {
                ...
                table = new Tabulator("#tab_recolectadas", {
                    ...
                    columns:[
                        ...
                        //{title:"Folio", field:"Folio", width:200},
                        {title:"Codigo", field:"Codigo", width:250, hozAlign:"center", sorter:"number"},
                        {title:"Fecha", field:"Fecha", sorter:"date"},
                        {title:"Hora", field:"Hora", hozAlign:"center"},
                        {title:"Tomador de muestra", field:"Tomador de muestra"},
                        {title:"Nombre De Cliente", field:"Nombre Cliente"},
